-- --------------------------------------------------------
-- 主机:                           bt2.test
-- 服务器版本:                        5.6.44-log - Source distribution
-- 服务器操作系统:                      Linux
...
-- 导出  表 l_admin.fa_auth_group_access 结构
